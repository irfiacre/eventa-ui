            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <div className="w-full text-textLightColor space-y-1">
                  <p>
                    <span className="text-primary pr-1">Price: </span>
                    {formatPrice(price)} Rwf
                  </p>
                  <p>
                    <span className="text-primary pr-1">Rooms: </span>
                    {rooms}
                  </p>
                  <p>
                    <span className="text-primary pr-1">Address: </span>
                    {`${province}, ${district}, ${sector}`}
                  </p>
                  <p>
                    <span className="text-primary pr-1">Furnished: </span>
                    {furnished ? "Yes" : "No"}
                  </p>
                </div>
              </div>
              ...
              {!booking && (
                <div className="w-full space-y-2">
                  ...
                  <Datepicker
                    ...
                    primaryColor={"amber"}
                    inputClassName="w-2/4 max-lg:w-3/4 border border-primary rounded-lg p-2.5"
              ...
              {booking && booking.status !== "canceled" && (
                <div>
                  {booking.status === "pending" ? (
                    ...
                    <div className="py-5 text-base text-primary space-x-2">
