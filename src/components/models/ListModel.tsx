      ...
      <div className="h-4/5 w-4/5">
        <BaseCard className="p-5 space-y-5 h-full w-full">
          <div className="p-2.5 text-center sm:items-center sm:p-0">
            ...
            <div className="px-6 overflow-auto h-[60vh]">
              {bookings.length > 0 ? (
                ...
                <p className="text-primary/70">{loading ? "Loading..." : "None so far!"}</p>
              )}
            </div>
            ...
            <div className="px-4 sm:flex sm:flex-row-reverse sm:px-6">
              <button
                ...
                disabled={loading}
                onClick={() => handleClose()}
                className="w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 ring-1 shadow-xs ring-gray-300 ring-inset hover:bg-gray-50 sm:mt-0 sm:w-auto disabled:text-gray-500"
              >
                Close
              </button>
            </div>
